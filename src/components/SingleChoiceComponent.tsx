import { updateCurrentlyEditingElement,addMultiChoiceFormOption,deleteMultiChoiceFormOption, editOptionMultipleFormOption } from '@/lib/features/editslice/editform.slice';
...
const SingleChoiceForm = ({
  ...
  id,
    ...
    const responses = useAppSelector((state) => state.ResponseForm.responses);
    const userModeOptions = useAppSelector((state) => state.ResponseForm.elements.find(el => el.id === id)?.options);
